...
>(({ className, children, onClose, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      'relative w-full rounded-xl border border-slate-200 bg-white p-6 shadow-2xl animate-in fade-in-0 zoom-in-95',
      className
    )}
    {...props}
  >
...
>(({ className, ...props }, ref) => (
  <h3
    ref={ref}
    className={cn(
      'text-lg font-bold leading-none tracking-tight text-[#1a2b5c]',
      className
    )}
    {...props}
  />
